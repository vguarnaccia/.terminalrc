...
All you need is bash, git, and python 2 or 3 for the installation script. I assume you have a decent .bashrc that colorizes your command line that you wish to extend without modifying. In case you don't, I included a template for a debian system.
...
* `grm`: `git rm`
* `grc`: `git rm --cached`
* `gc`: quick commit message, example: `gc add new alias` = `git commmit -m "add new alias"` 
